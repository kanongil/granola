...
## Logging Issues
All issues should be created using the [new issue form](https://github.com/hapijs/granola/issues/new). Clearly describe the issue including steps
...
* [Pull requests](http://help.github.com/send-pull-requests/) should be made to the [master branch](https://github.com/hapijs/granola/tree/master).
